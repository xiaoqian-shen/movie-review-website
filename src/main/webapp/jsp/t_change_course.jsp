...
<%
    ...
    try {
        ...
        if (conn != null) {
            ...
            PreparedStatement tmt = conn.prepareStatement("delete from teaches where course_id='"+course_id+"'");
            int rss = tmt.executeUpdate();
            if(rss!=0){
                out.println("<script language='javascript'>alert('修改成功');window.location.href='t_course.jsp';</script>");
            }
        }
        else{
            out.print("连接失败！");
